...
public class DownloadTrackRecordData extends AsyncTask<String,String,String> {
    ...
    public DownloadTrackRecordData(Context mContext, TrackListAdapter adapter, RecyclerView trackRecyclerView) {
    ...
    protected void onPreExecute() {
        ...
        p = new ProgressDialog(mContext, ProgressDialog.THEME_HOLO_DARK);
    ...
    protected void onPostExecute(String s) {
        ...
        if (myListData != null) {
            p.hide();
            adapter = new TrackListAdapter(mContext, myListData);
