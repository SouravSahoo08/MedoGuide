...
public class TrackListData {
    ...
    //to handle world Record data
    public TrackListData(String typeName, String population, String no_of_cases, String no_of_active_cases, String critical_cases, String recovered_cases, String deaths, String affected_countries) {
        this.countryName = typeName;
    ...
    public TrackListData(String typeName, String population, String no_of_cases, String no_of_active_cases, String critical_cases, String recovered_cases, String deaths) {
        this.countryName = typeName;
        this.population = population;
        this.no_of_cases = no_of_cases;
        this.no_of_active_cases = no_of_active_cases;
